pluginManagement {
    // Keep EngineHub plugin mirrors explicit; dependency repositories also need local Pinac.
    repositories {
        maven {
            name = "EngineHub"
...
dependencyResolutionManagement {
    repositories {
        ...
        maven { url = uri("https://maven.canvasmc.io/public/") }
        maven {
            name = "PaperMC"
        ...
        maven {
            ...
            content { includeGroup("com.sk89q.lib") }
        }
        mavenCentral()
        maven {
